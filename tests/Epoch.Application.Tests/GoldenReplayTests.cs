...
namespace Epoch.Application.Tests
{
    ...
    public static class GoldenReplayTests
    {
        ...
        public static void EmitGoldens()
        {
            ...
            json.Append("  \"regeneratedAt\": \"M2\",\n");
            json.Append("  \"regenerationReason\": \"One-time and owner-approved. Two things moved every value below, exactly once. (1) contentHash replaced the M1 placeholder sha256:pending-m2 with the canonical content hash, and contentPoolHash is part of authoritative state. (2) M2 effect-coverage found five authored effects that M1 loaded but never executed - lane-scoped income perks PERK_ECO_RIVER_GROWTH, PERK_UTIL_COAST_GROWTH, PERK_UTIL_HIGHLAND_INSIGHT and PERK_CONV_RIVER_INSIGHT, plus BUILD_GARRISON_POST structure Power - and they now apply, which changes outcomes. No rule, Age table, authored value or balance number was changed.\",\n");
            json.Append("  \"runs\": [\n");
